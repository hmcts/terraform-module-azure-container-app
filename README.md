...
| Name                                                         | Version   |
| ------------------------------------------------------------ | --------- |
| <a name="provider_azurerm"></a> [azurerm](#provider_azurerm) | >= 3.70.0 |
...
| <a name="input_component"></a> [component](#input_component)                                                                            | [https://hmcts.github.io/glossary/#component](https://hmcts.github.io/glossary/#component)                  | `string`                                                                                                                                                                                                                         | n/a          |   yes    |
| <a name="input_containers"></a> [containers](#input_containers)                                                                         | Container configuration                                                                                     | <pre>map(object({<br/> image = string<br/> cpu = number<br/> memory = string<br/> env = optional(list(object({<br/> name = string<br/> secret_name = optional(string)<br/> value = optional(string)<br/> })), [])<br/> }))</pre> | n/a          |   yes    |
...
| <a name="input_product"></a> [product](#input_product)                                                                                  | [https://hmcts.github.io/glossary/#product](https://hmcts.github.io/glossary/#product)                      | `string`                                                                                                                                                                                                                         | n/a          |   yes    |
