...
| <a name="input_containers"></a> [containers](#input\_containers) | Container configuration | <pre>list(object({<br/>    name   = string<br/>    image  = string<br/>    cpu    = number<br/>    memory = string<br/>    env = optional(list(object({<br/>      name        = string<br/>      secret_name = optional(string)<br/>      value       = optional(string)<br/>    })), [])<br/>  }))</pre> | n/a | yes |
